          ...
          <table class="table table-bordered border-primary">
            ...
            <tbody>
              <?php foreach ($bikes as $bike) : ?>
                <tr>
                  <th scope="row"><?php echo $bike['id']; ?></th>
                  <td><?php echo $bike['number']; ?></td>
                  <td><?php echo $bike['name']; ?></td>
                  <td><?php echo $bike['bike_id']; ?></td>
                  <td><?php echo $bike['status']; ?></td>
                  <td><?php echo $bike['owner']; ?></td>
                  <td><?php echo $bike['agent_username']; ?></td>
                  <td><?php echo $bike['agent_nid']; ?></td>
                  <td><?php echo $bike['approved_motif']; ?></td>
                  <td><?php echo $bike['use_type']; ?></td>
                  <td>
                    <div class="btn-group">
                      <!-- Add the appropriate URLs for edit and delete -->
                      <a href="?page=edit&id=<?php echo $bike['id']; ?>" class="btn btn-primary btn-flat btn-sm manage_bike">
                        <i class="bi bi-pencil"></i>
                      </a>
                      <a href="?delete=<?php echo $bike['id']; ?>" class="btn btn-danger btn-sm btn-flat delete_bike" onclick="return confirm('Are you sure you want to delete this bike?')">
